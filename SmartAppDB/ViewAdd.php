...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<?php
			...
			$result=mysqli_query($mysqli,"Select * from usendadvertiesement where SID='".$sendID."' ");
			if (!$result) {
			printf("Error: %s\n", mysqli_error($mysqli));
			exit();
			}
		...
		<div class="panel-body">
			<form name="form1"  method="POST" action="block.php">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="department" value="<?php echo $row['Selection'] ?>" disabled>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="lnam">Recieved Date</label>
