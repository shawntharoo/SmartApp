...
<body>
      ...
      <div class="col-md-2" style="width: 190px">
                          ...
                          <?php
                              ...
                              <div class="floating-box">
                                  <div class="an"> 
                                        <img src="<?php echo $row['image']; ?>" alt="profile-sample5" class="img-circle" data-toggle="modal" data-target="#myModal" alt="Cinque Terre" width="190" height="200" />
 ...
 <div style="background-color: #999999;opacity: 0.9;margin-left: 210px;margin-right: 120px;min-height: 100%;padding-top: 0px">
                                    ...
                                    <div class="row searchgroup" style="padding-left:20px;padding-bottom: 10px">
                                      <form method="post">
                                          <div class="row search_col">
                                                           ...
                                                           <button class="search_btn" name="searchkey4" style="height:40px;width:40px"><img src="imag/srch.png" width="25" height="25"/></button>
                                            </div>
                                       </form>
                                       </div>
                                </td>
                                                               ...
                                                               <?php
                                                                 ...
                                                                 if(isset($_POST["sortkey"])){
                                                                              ...
                                                                              <div class="card">
                                                                                                ...
                                                                                                <td style="padding-left: 200px"><h5><?php echo $row['date'];?></h5></td>
    ...
    <div class="modal-dialog">
         ...
         <!-- Modal content-->
            <div class="modal-content">
              ...
              <h4 class="modal-title" style="color: red">Group Settings</h4>
              </div>
              <div class="modal-body">
                                                   
                <div style="padding-left: 440px">
                <button type="button" class="btn btn-info btn-lg" data-dismiss="save" onclick="javascript:Unfollow(<?php echo $a;?>)" style="background-color: #190961;color: white">Unfollow</button>
                <script type="text/javascript">
                  function Unfollow(a,b) {
                      if(confirm('Are you sure you want to unfollow this group'))
                       {
                        window.location.href='unfollow.php?id='+a;
                       }
                  }
               </script>
                </div>
                <br/>
                <?php 
                $sqlGetDatam="select * from user u,group_participants p where p.userid=u.id and p.groupid=".$a;
                $resultm=mysqli_query($con,$sqlGetDatam);
                while($rowm=mysqli_fetch_array($resultm)){?>
                <div class="row search_col" style="padding-left: 30px;width: 598px;background-color: #ccccff">
                <h4><p> </p> <img src="<?php echo $rowm['uimage']; ?>" alt="profile-sample5" class="img-circle" alt="Cinque Terre" width="50" height="50"/>
                <?php echo $rowm['name']; ?></h4>
                </div>
               <?php } ?>
             </div>                                       
          </div>
